...
var students = new List<Student>{
   ...
   new Student(2, "Eduardo Matheus", "987654321", new DateTime(1996, 05, 08), new List<string>{"123456789", "73987654321"}),
   new Student(3, "Maria Cristina", "123456789", new DateTime(1966, 10, 07), new List<string>{"123456789", "77988237086"})
};
